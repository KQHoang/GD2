<template>
                                    ...
                                    <td class="custom-column custom-button">
                                        <div class="flex justify-flexend m-8">
                                            <div class="style-button">
                                             ...
                                             <div class="style-button">
                                                <div class="button-comand-wrap btn-more">
                                                    <div class="icon-delete-custom" @click="deleteUser"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
    ...
    <PopUp v-if="showPopUp" :buttonName="buttonName" :popUpStyle="popUpStyle"
        :popUpTitle="popUpTitle" :buttonStyle="buttonStyle" @closePopUp="closePopUp" 
        :userName="userName" :listRole="listRole"
    />
    
    <!-- user detail -->
    <div class="detail-preview-user" id="previewSettingUser" style="display: none;">
        <div class="content-user">
            ...
            <div class="ms-row-detail">
                ...
                <div class="body-preview">
                    ...
                    <div class="font-20 bold detail-work-info">THÔNG TIN PHÂN QUYỀN</div>
